...
export function makeDraggable(element) {
  element.addEventListener('mousedown', function (e) {
    ...
    document
      ...
      .addEventListener('mousemove', elementDrag);
    document
      .getElementById('editor')
      .addEventListener('mouseup', closeDragElement);
    hLine = createLine('horizontal');
    vLine = createLine('vertical');
    document.getElementById('editor').appendChild(hLine);
    document.getElementById('editor').appendChild(vLine);
  });
  ...
  function closeDragElement(e) {
    document
      .getElementById('editor')
      .removeEventListener('mousemove', elementDrag);
    document
      .getElementById('editor')
      .removeEventListener('mouseup', closeDragElement);
    hideAlignmentLines();
  }
}
...
function hideAlignmentLines() {
  const hLineToRemove = document
    .getElementById('editor')
    .querySelector('.line.horizontal');
  const vLineToRemove = document
    .getElementById('editor')
    .querySelector('.line.vertical');
...
function dragStopped(e) {
  document.getElementById('editor').onmouseup = null;
